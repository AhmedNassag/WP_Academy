...
thim_customizer()->add_field(
	array(
		...
		'section'   => 'copyright',
		'default'   => '<a href="' . esc_url( 'https://freecodezilla.net/eduma-education-wordpress-theme/' ) . '" target="_blank">Education WordPress Theme</a> by <a href="' . esc_url( 'https://freecodezilla.net' ) . '" target="_blank">Freecodezilla</a> Powered by WordPress.',
		'priority'  => 100,
		'transport' => 'postMessage',
		'js_vars'   => array(
			array(
